...
public class Answer {
	...
	public String toString() {
		return "Answer [answerId=" + answerId + ", answerContent=" + answerContent + ", likedCount=" + likedCount
				+ ", createTime=" + createTime + ", questionId=" + questionId + ", userId=" + userId + ", question="
				+ question + ", user=" + user + ", likeState=" + likeState + ", answerCommentList=" + answerCommentList
				+ "]";
	}
